#!/usr/bin/env python3
"""
DeepSeek Experiment: Can models reason in code? (HMMT Version)
...
def main():
    ...
    print("=" * 80)
    print("Can models reason in code? - DeepSeek Experiment (HMMT)")
    print("=" * 80)
    print(f"Reasoning Model: {reasoning_model}")
    print(f"Non-Reasoning Model: {non_reasoning_model}")
    ...
    output_file = "deepseek_hmmt_experiment_results.json"
