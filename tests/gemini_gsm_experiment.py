#!/usr/bin/env python3
"""
Gemini Experiment: Can models reason in code? (GSM8K Version)

This experiment measures the effect of code vs comments vs both vs nothing
on model performance using the GSM8K test dataset and Gemini API.
...
def main():
    ...
    print("=" * 80)
    print("Can models reason in code? - Gemini Experiment (GSM8K)")
    print("=" * 80)
    print(f"Model: {model_name}")
    ...
    output_file = "gemini_gsm_experiment_results.json"
