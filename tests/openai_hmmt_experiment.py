#!/usr/bin/env python3
"""
OpenAI Experiment: Can models reason in code? (HMMT Version)
...
def main():
    ...
    print("=" * 80)
    print("Can models reason in code? - OpenAI Experiment (HMMT)")
    print("=" * 80)
    print(f"Model: {model}")
    print(f"Reasoning effort (reasoning): {reasoning_effort}")
    print(f"Reasoning effort (non-reasoning): {no_reasoning_effort}")
    ...
    output_file = "openai_hmmt_experiment_results.json"
