#!/usr/bin/env python3
"""
Grok Experiment: Can models reason in code? (GSM8K Version)

This experiment measures the effect of code vs comments vs both vs nothing
on model performance using the GSM8K test dataset and Grok API.
...
def main():
    ...
    print("=" * 80)
    print("Can models reason in code? - Grok Experiment (GSM8K)")
    print("=" * 80)
    print(f"Reasoning Model: {reasoning_model}")
    print(f"Non-Reasoning Model: {non_reasoning_model}")
    ...
    output_file = "grok_gsm_experiment_results.json"
