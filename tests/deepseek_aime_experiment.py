#!/usr/bin/env python3
"""
DeepSeek Experiment: Can models reason in code?

This experiment measures the effect of code vs comments vs both vs nothing
on model performance using the AIME condensed dataset and DeepSeek API.
...
def main():
    ...
    print("=" * 80)
    print("Can models reason in code? - DeepSeek Experiment")
    print("=" * 80)
    print(f"Reasoning Model: {reasoning_model}")
    print(f"Non-Reasoning Model: {non_reasoning_model}")
