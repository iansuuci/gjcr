#!/usr/bin/env python3
"""
OpenAI Experiment: Can models reason in code? (GSM8K Version)

This experiment measures the effect of code vs comments vs both vs nothing
on model performance using the GSM8K test dataset and OpenAI API.
...
def main():
    ...
    print("=" * 80)
    print("Can models reason in code? - OpenAI Experiment (GSM8K)")
    print("=" * 80)
    print(f"Model: {model}")
    print(f"Reasoning effort (reasoning): {reasoning_effort}")
    print(f"Reasoning effort (non-reasoning): {no_reasoning_effort}")
    ...
    output_file = "openai_gsm_experiment_results.json"
